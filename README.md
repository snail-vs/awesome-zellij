...
* [harpoon (⭐199)](https://github.com/Nacho114/harpoon) quickly navigate panes (clone of nvim's harpoon)
* [neolij (⭐27)](https://github.com/y2w8/neolij.nvim) Seamless Neovim/Zellij integration with built-in navigation, pane/tab management, and Lua scripting.
* [room (⭐288)](https://github.com/rvcas/room) quickly search and switch tabs 🖤
* [vim-zellij-navigator (⭐177)](https://github.com/hiasr/vim-zellij-navigator) Seamless navigation with vim in zellij
...
* [zellij-pane-picker (⭐27)](https://github.com/shihanng/zellij-pane-picker) quickly switch, star, and jump to panes with customizable keyboard shortcuts
...
* [zbuffers (⭐23)](https://github.com/Strech/zbuffers) a minimal and convenient way to switch between tabs, inspired by Emacs vertico-buffers and Zellij session-manager
* [zellij-attention (⭐49)](https://github.com/KiryuuLight/zellij-attention) add notification icons to tab names when panes need attention, designed for Claude Code
* [zellij-autolock (⭐157)](https://github.com/fresh2dev/zellij-autolock) Automatically lock Zellij depending on the command in the focused pane. Seamless navigation for Vim and more. Pairs well with [zellij.vim (⭐65)](https://github.com/fresh2dev/zellij.vim).
* [zellij-bookmarks (⭐43)](https://github.com/yaroslavborbat/zellij-bookmarks) manage command bookmarks and quickly insert them into the terminal
...
* [zjsh (⭐7)](https://github.com/saweima12/zjsh) a Zellij session launcher with project config, session discovery, resurrection support, zoxide integration, and fzf/gum support
...
* [zellij-forgot (⭐248)](https://github.com/karimould/zellij-forgot) swiftly present and access your keybinds (and more)
...
* [ghost (⭐65)](https://github.com/vdbulcke/ghost) spawn floating command terminal pane (interactive zrf)
* [multitask (⭐151)](https://github.com/imsnif/multitask) a mini-CI as a Zellij plugin
* [zellij-attention (⭐49)](https://github.com/KiryuuLight/zellij-attention) add notification icons to tab names when panes need attention, designed for Claude Code
* [zellij-bookmarks (⭐43)](https://github.com/yaroslavborbat/zellij-bookmarks) manage command bookmarks and quickly insert them into the terminal
* [zellij-link-extended (⭐2)](https://github.com/bezbac/zellij-link-extended) extends the built-in link plugin to open files, directories, and links via a configurable command
* [zellij-notepad (⭐10)](https://github.com/0xble/zellij-notepad) floating notepad pane with configurable editor, position, and timestamped notes
* [zellij-palette (⭐10)](https://github.com/timonwong/zellij-palette) a fuzzy command palette for pane, tab, session, and theme actions, with custom commands and shell-backed sources
...
* [zellit (⭐16)](https://github.com/allisonhere/zellit) A terminal UI for creating, editing, and applying Zellij themes.
...
* [zellij-urlview (⭐0)](https://github.com/VV0JC13CH/zellij-urlview) Quickly open displayed url(s)! Inspired by [tmux-urlview](https://github.com/tmux-plugins/tmux-urlview)
...
* [zide (⭐329)](https://github.com/josephschmitt/zide) Zellij layouts + bash scripts to create an IDE-like file picker and editor workflow that works in any shell and with most any visual file pickers!
